...
| **표기 정규화 + 규칙 확장 최종본** | **98.12** | **94.23~95.77** | **0.991** | `keyword_completion_extension_experiment.ipynb` |
...
| 규칙 기반 후처리 적용 | 86.71 | 86.54 | KEYWORD_COMPLETION_RULES 반영, 채점기 v3.1.0 |
| 규칙 기반 후처리 재실행 | 86.97 | 86.85 | 재현성 확인용 재실행, 인용 형식 저하 발견 → 근거 블록 위치 수정으로 후속 조치 |
| 표기 정규화 반영 | 88.84 | 89.17 | g11/g12/g15/g16 개선, 대괄호 파일명 오인식 수정 |
