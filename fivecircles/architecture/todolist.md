...
- [ ] **EVO35.3d** [TEXT_COMPLETE_VISUAL_PENDING_SOLO] Active seed-v2 only: train38 / dev15 / sealed15; support audit 49/49 PASS; sealed `889819c4...`, bundle `ddd3abf5...`; sealed holdout has never been executed. Active relay: `../work/2026-09-09-evo35-3d-relay.md`.
  ...
  - [ ] **EVO35.3d.C.VISUAL** Collect/validate visual + mixed trajectories on TRAIN 12 and DEV 4 using a fresh-doc visual OCR/index path; do not execute SEALED visual/mixed cases.
