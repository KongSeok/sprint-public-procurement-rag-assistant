...
- 현재: Phase 0 `c2c621c`, Phase 1 `ff9fa2e`, c2 `05fc4cc`, c3.1 `7b7af7d` origin push 완료.
  EH2.1~2.5와 EH2.6.a~c3.2 PASS; 다음 leaf `EH2.6.c3.3.a` absence reason/prerequisite 계약·TDD.
...
- 테스트: EH2.6.c3.2 focused9/related128/full1229/safety854 PASS. ID-less rerank, global role order, exact owner budget,
  auxiliary parent 비승격과 base/derived route 단일 소비를 닫았고, 다음은 bounded absence를 계약·TDD로 고정한다.
