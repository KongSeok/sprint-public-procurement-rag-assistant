...
- 현재: Phase 0 `c2c621c`, Phase 1 `ff9fa2e`, c2 `05fc4cc`, c3.1 `7b7af7d`, c3.2 `2c3b077`,
  c3.3 `7dd5ad4`, c3.4 `3c2d7d0`, c3.5 `aa0ff9d` origin push 완료. EH2.1~2.5와 EH2.6.a~d1 PASS;
  다음 leaf는 `EH2.6.d2` allowed action/decision permit이다.
...
- 계약: `../architecture/specs/bidfit-evidence-harness-v1-rc0.md` §16.10의 d1/d2 구간과
  `../architecture/todolist.md` EH2.6.d만 우선 읽기.
- TODO: `../architecture/todolist.md` EH-RC0. 상세/원문은 애매할 때만 checkpoint/resume 문서에서 찾기.
- 테스트: EH2.6.d1 focused10/related234/full1298/safety868과 flow Playwright, 독립 APPROVE. exact initial
  state/store/config/runtime에서만 idempotent한 zero-consumption execution aggregate를 발급하며 clone·nested
  drift·mixed dependency·concurrency·GC tombstone·serialization 비승격을 닫았다. d2 decision permit, c4 live
  effect mint/reducer, d3 start/step/run은 계속 부재한다.
