...
이제 이걸 실제로 팀/사용자가 눌러볼 수 있는 화면으로 옮기는 단계 - 우제가
...
[2026-09-09 추가 - 🤖 AI 요약] 우제가 "후보들의 parent chunk까지 가져와서
...
남겨두고(지금까지의 "후보만 보여주고 사람이 확인" 철학 유지 - 우제가 대체가
